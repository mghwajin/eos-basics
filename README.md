...
- [Pacman updates troubleshooting](./contents/pacman-updates-troubleshooting.md)
  - [GPGME error: No data](./contents/pacman-updates-troubleshooting.md#gpgme-error-no-data)
  - [Mirrorlist errors and warnings](./contents/pacman-updates-troubleshooting.md#mirrorlist-errors-and-warnings)
  - [Installed as .pacnew or .pacsave](./contents/pacman-updates-troubleshooting.md#installed-as-pacnew-or-pacsave)
- [System maintenance](./contents/system-maintenance.md)
  - [Create system backups](./contents/system-maintenance.md#create-system-backups)
  - [Update system](./contents/system-maintenance.md#update-system)
  - [Update mirrors](./contents/system-maintenance.md#update-mirrors)
  - [Clear unused files](./contents/system-maintenance.md#clear-unused-files)
- [xfce4-screenshooter](./contents/xfce4-screenshooter.md)
